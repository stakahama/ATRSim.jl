...
ATR calculations from Arangio et al. doi:[10.1177/0003702818821330](https://doi.org/10.1177/0003702818821330), 2019. Equations originally taken from the following sources:
...
The following figure is slightly different from Figure S2 (bottom panel) in Arangio et al. as the version below is calculated assuming the penetration depth is not be influenced by the sample medium n₂ (bulk), but instead n₃ (thin flim) (Mirabella, 1985).
```{julia}
#| output: true
pl = plot(layout = (2, 1))
